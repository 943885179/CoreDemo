...
namespace CoreDemo_StackexchageRedis
{
    public class RedisClient : IDisposable
    {
        ...
        {
            return _connections.GetOrAdd(redisConfig["InstanceName"], p => ConnectionMultiplexer.Connect(redisConfig["Connection"]));
        }
        /// <summary>
        /// 检查入参数
        /// </summary>
        ...
        /// <returns></returns>
        public IDatabase GetDatabase(string configName = null, int db = 0)
        {
            ...
            {
                db = intDefaultDatabase;
            }
            return GetConnect(redisConfig).GetDatabase(db);
        }
